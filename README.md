# 👋 Olá! Eu sou Paulo Ricardo Tebet Lyrio

## 🚀 Desenvolvedor Backend | Java • Spring Boot • Python • AWS • Microsserviços

[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Paulouuul)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/paulo-ricardo-tebet-lyrio-8258b619b)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:tebetpaulo91@yahoo.com)
...
- Introdução à Criação de Websites com HTML5 e CSS3 (DIO)
- Introdução ao Spring Framework com Spring Boot (DIO)
- Introdução à Plataforma Java (DIO)
- Introduction to Data Science (Cisco)
- Versionamento de Código com Git e GitHub (DIO)
- Contextualizando o Desenvolvimento Web com Spring Boot (DIO)
...
- 🇺🇸 **Inglês** – Avançado (leitura técnica, documentação, comunicação)
- 🇪🇸 **Espanhol** – Básico
...
⭐ *"Transformando requisitos em soluções escaláveis e bem estruturadas"*
